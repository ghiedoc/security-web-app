                        ...
                        <!-- <div class="alert alert-danger alert-dismissable" dispaly="none">
                         ...
                         <form action=" forgotPassword.php" method="post"> 
                               ...
                               <p style="display:none">
                                ...
                                <div class="form-group">
                                    <input type="password" name="newpassword" id="newpassword" class="form-control" placeholder="New Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain atleast one number and one uppercase and lowercase letter, and atleast 8 or more characters"
                                        required autocomplete="off"
                                         />
                                        <span toggle="#input-pwd" class="fa fa-fw fa-eye field-icon toggle-password"></span>
                                </div>
...
if ( isset( $_POST['forgot'] )) {
    ...
    $querys = "SELECT * FROM patienttb WHERE email='$email' and password='$oldpassword'";
    $results = mysqli_query( $con, $querys );
    
    $checker=mysqli_num_rows($results);
  if ($checker > 0) {
    $checkerEmailPassword=true;
